...
- **Haptic Composer** — system-safe feedback, empirical actuator waveforms, device routing, rhythm presets, a 16-step pattern editor, tempo control, and press-and-hold continuous pulses capped at 120 Hz.
...
Apple’s public haptic API deliberately does not expose strength, duration, arbitrary waveform, or device targeting. “Intensity” in System mode therefore means selecting and timing Apple’s three patterns. Enhanced mode exposes more tactile character, but its waveform numbers and raw-contact structure are empirical and may change across macOS or trackpad firmware.
